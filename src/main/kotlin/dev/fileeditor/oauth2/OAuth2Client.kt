 ...
 *
 * @constructor Create new OAuth2Client
 */
interface OAuth2Client {
    ...
    /**
     * Starts a [Session][dev.fileeditor.oauth2.session.Session] with the provided code,
     ...
     *
     * @throws InvalidStateException If the state, when consumed by this client's StateController,
     * results in a `null` redirect URI.
     */
    ...
    /**
     * Requests a [OAuth2User] from the [Session][dev.fileeditor.oauth2.session.Session].
     *
     ...
     * @return A [OAuth2Action] for the OAuth2User to be retrieved.
     */
    fun getUser(session: Session): OAuth2Action<OAuth2User>

    /**
     * Requests a list of [OAuth2Guilds][OAuth2Guild] from the [Session].
     *
     * All Sessions should handle an individual Discord User, and as such this method retrieves
     ...
     * @return A [OAuth2Action] for the OAuth2Guilds to be retrieved.
     * @throws MissingScopeException If the provided Session does not have the 'guilds' scope.
     */
    ...
    /**
     * Revoke [Session][dev.fileeditor.oauth2.session.Session] token.
     *
     ...
     *
     * At minimum, the developer must provide a valid Client ID and secret.
     *
     * @constructor Create new Builder
     */
    class Builder {
         ...
         *
         * @param clientId The OAuth2Client's ID.
         * @return This builder.
         */
         ...
         *
         * @param clientSecret The OAuth2Client's secret.
         * @return This builder.
         */
         ...
         *
         * @param client The OAuth2Client's OkHttpClient.
         * @return This builder.
         */
